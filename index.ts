...
export namespace send {
    ...
    export function error(message: string, actor?: ServerPlayer): void {
        ...
        else console.log(`[Simple-Bossbar] Error! ${message.replace(/&e/g, "").replace(/&7/g, "").replace(/&r/g, "").replace(/&/g, "")}`);
    }
    /**Send error message. */
    export function success(message: string, actor?: ServerPlayer): void {
        ...
        else console.log(`[Simple-Bossbar] ${message.replace(/&e/g, "").replace(/&7/g, "").replace(/&r/g, "").replace(/&/g, "")}`);
    }
    /**Send error message. */
